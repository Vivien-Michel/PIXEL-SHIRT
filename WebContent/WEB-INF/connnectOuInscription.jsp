				...
				<div class="col-md-6 col-md-offset-3">
					<form method="POST" action="${pageContext.request.contextPath}/Panier/AdresseFacturation">
						...
						<div class="form-group has-feedback">
					        ...
					        <button type="submit" class="pull-right btn btn-lg btn-success">Se connecter</button>
					...
					<form role="form" method="POST" action="${pageContext.request.contextPath}/ConnnexionOrInscription">
						...
						<div class="form-group has-feedback">
							<label class="control-label">Nom* :</label> <input
								...
								value="<c:out value="${utilisateur.nom}"/>" id="nom" name="nom">
						...
						<div class="form-group has-feedback">
							<label class="control-label">Prénom* :</label> <input
								class="form-control" type="text" placeholder="Votre prénom"
						...
						<div class="form-group has-feedback">
							<label class="control-label">Adresse* :</label> <input
								class="form-control" type="text" placeholder="Votre adresse"
						...
						<div class="form-group has-feedback">
							<label class="control-label">Code postal* :</label> <input
								class="form-control" type="text" placeholder="Votre code postal"
								value="<c:out value="${utilisateur.codePostal}"/>"
								id="codePostal" name="codePostal"> <span class="erreur">${form.erreurs['codePostal']}</span>
						</div>
						<div class="form-group has-feedback">
							<label class="control-label">Ville* :</label> <input
								class="form-control" type="text" placeholder="Votre ville"
						...
						<div class="form-group has-feedback">
							<label class="control-label">Mot de passe* :</label> <input
								...
								placeholder="Votre mot de passe" id="motdepasse"
						...
						<div class="form-group has-feedback">
							...
							<input class="form-control" type="password"
								...
								id="confirmation" name="confirmation" value="">
							<!-- <span class="fa fa-check form-control-feedback"></span>-->
