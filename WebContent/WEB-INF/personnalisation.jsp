...
<script type="text/javascript">
    ...
    var pixelShirt = JSON.parse(sessionStorage.pixelShirt || '{}');
...
<body>
	...
	<div class="container">
		...
		<div id="colorholder" class="col-sm-1" style="top:60px;width:22px;height:22px;margin:1px;"><h1 class="text-danger">WORK IN PROGRESS</h1></div>
            ...
            <h1>Tee-Shirt</h1>
            <form class="form-horizontal" role="form" action="Personnalisation?id=${article.id_article}" method="POST">
